...
@export (Texture2D) var top_texture : set = set_top_texture
@export (Color) var top_color : = Color(1,1,1) : set = set_top_color
@export (Texture2D) var left_texture : set = set_left_texture
@export (Color) var left_color : = Color(1,1,1) : set = set_left_color
@export (Texture2D) var right_texture : set = set_right_texture
@export (Color) var right_color : = Color(1,1,1) : set = set_right_color
@export (bool) var antialiasing = true : set = set_antialiasing
@export (float) var height = 1.0 : set = set_height
@export (bool) var perfect_iso = false : set = set_perfect_iso
...
@export (UvAdaptMode) var adapt_uv = UvAdaptMode.TOP : set = set_adapt_uv
...
# Colors Array
var _cached_top_pool_color : PackedColorArray
var _cached_left_pool_color : PackedColorArray
var _cached_right_pool_color : PackedColorArray

# Points Array
var _cached_top_point_array : PackedVector2Array
var _cached_left_point_array : PackedVector2Array
var _cached_right_point_array : PackedVector2Array

# Uvs
var _cached_adapted_uvs : PackedVector2Array
...
func _update_rect_size():
	_cached_size = size.x/2
	_update_side()
	_update_cached_y_position_difference()
	size.y = _cached_size + _cached_side
	update()
...
func _ready():
	...
	connect("resized",Callable(self,"_update_rect_size"))
